...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reuniao.duracao'
        db.add_column('projeto_reuniao', 'duracao',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(12, 19, 37, 414000)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reuniao.duracao'
        db.delete_column('projeto_reuniao', 'duracao')
    ...
    models = {
        ...
        'projeto.reuniao': {
            ...
            'duracao': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(12, 19, 37, 414000)'}),
