...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tarefa.status'
        db.alter_column('projeto_tarefa', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projeto.StatusTarefa']))

        # Changing field 'Tarefa.tipo_tarefa'
        db.alter_column('projeto_tarefa', 'tipo_tarefa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projeto.TipoTarefa']))
    ...
    models = {
        ...
        'projeto.reuniao': {
            ...
            'duracao': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 18, 27, 177000)'}),
